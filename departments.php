...
<head>
    ...
    <title> DEPARATMENT | Divyam Hospital </title>
...
<body>
    ...
    <section class="cid-rGsOllGbjd" id="header4-1h">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-7 img-col" id="topheight" >
                  
                    <div class="mbr-figure" >
                        <img src="doctor/01department.jpg" alt="not found" style="margin: top 10px;">
                    </div>
    ...
    <section class="features1 cid-rGtBqmc2gI" id="features6-33">
        <div class="container">
        <h1 class="mbr-section-title align-left mbr-bold pb-4 mbr-fonts-style display-1"> DEPARTMENTS</h1>
            <div class="row">
                ...
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper align-left card1 ">
                        ...
                        <div class="card-box">
                            <h4 class="card-title pb-2 mbr-bold mbr-fonts-style display-5">Emergency Department</h4>
                            <p class="mbr-text pb-4 mbr-fonts-style display-4">The emergency Department is the first point of contact for any critically ill patient, needing immediate medical attention.</p>
                    ...
                    <div class="card-wrapper  align-left card2 ">
                        ...
                        <div class="card-box">
                            <h4 class="card-title pb-2 mbr-bold mbr-fonts-style display-5">
                                Surgery Department </h4>
                            <p class="mbr-text pb-4 mbr-fonts-style display-4">
                                The surgery department is where patients go for surgical intervention to treat medical conditions or injuries. </p>
                                <br>
                            <h5 class="link mbr-semibold mbr-fonts-style display-4"><a href="appointment.php" class="text-black">
                                    Appointement</a></h5>
                        </div>
                ...
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper  align-left card3 ">
                        ...
                        <div class="card-img">
                        <img src="doctor/out-pateint.svg" alt=""  width="48px" height="48px">
                        </div>
                        <div class="card-box">
                            <h4 class="card-title pb-2 mbr-bold mbr-fonts-style display-5">
                                Outpatient Department</h4>
                            <p class="mbr-text pb-4 mbr-fonts-style display-4">
                                The outpatient department patients visit the hospital for a consultation, diagnosis and treatment but don't get admission.  </p>
                            <h5 class="link mbr-semibold mbr-fonts-style display-4"><a href="appointment.php" class="text-black">
                                    Appointement</a></h5>
                        </div>
                    </div>
                ...
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper  align-left card4 ">
                        ...
                        <div class="card-img">
                        <img src="doctor/inpatient.svg" alt=""  width="48px" height="48px">
                        </div>
                        <div class="card-box">
                            <h4 class="card-title pb-2 mbr-bold mbr-fonts-style display-5">Inpatient Department</h4>
                            <p class="mbr-text pb-4 mbr-fonts-style display-4">
                                The inpatient department is part of the hospital where patients are admitted for medical treatment and care. </p>
                                <br>
                            <h5 class="link mbr-semibold mbr-fonts-style display-4"><a href="appointment.php" class="text-black">
                                    Appointement</a></h5>
                        </div>
            ...
            <div class="row">
                ...
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper  align-left card4 ">
                        ...
                        <div class="card-box">
                            <h4 class="card-title pb-2 mbr-bold mbr-fonts-style display-5">Intensive Care Unit (ICU)</h4>
                            <p class="mbr-text pb-4 mbr-fonts-style display-4">
                                The intensive care unit (ICU) is a specialized department in the hospital that provides critical care to patients who are in life-threatening conditions or require constant monitoring and treatment.</p>
                            <h5 class="link mbr-semibold mbr-fonts-style display-4"><a href="appointment.php" class="text-black">
                                    Appointement</a></h5>
                        </div>
                    </div>
                ...
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper  align-left card3 ">
                        ...
                        <div class="card-box">
                            <h4 class="card-title pb-2 mbr-bold mbr-fonts-style display-5">
                                Cardiology Department</h4>
                            <p class="mbr-text pb-4 mbr-fonts-style display-4">
                                The cardiology department is where patients go for the diagnosis and treatment of heart-related conditions, such as heart disease, heart attacks, and arrhythmias.  </p>
                            <h5 class="link mbr-semibold mbr-fonts-style display-4"><a href="appointment.php" class="text-black">
                                    Appointement</a></h5>
                        </div>
                    </div>
                ...
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper  align-left card2 ">
                        ...
                        <div class="card-box">
                            <h4 class="card-title pb-2 mbr-bold mbr-fonts-style display-5">
                                Neurology Department</h4>
                            <p class="mbr-text pb-4 mbr-fonts-style display-4">
                                The neurology department is where patients go for the diagnosis and treatment of neurological conditions, such as stroke, epilepsy, and Parkinson’s disease. </p>
                                <br>
                            <h5 class="link mbr-semibold mbr-fonts-style display-4"><a href="appointment.php" class="text-black">
                                    Appointement</a></h5>
                        </div>
                ...
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper align-left card1 ">
                        ...
                        <div class="card-box">
                            <h4 class="card-title pb-2 mbr-bold mbr-fonts-style display-5">Psychiatry Department</h4>
                            <p class="mbr-text pb-4 mbr-fonts-style display-4">Psychiatry department deals with the diagnosis, treatment and prevention of mental illness and disorders.</p>
                            <br>
                            <br>
                            <h5 class="link mbr-semibold mbr-fonts-style display-4"><a href="appointment.php" class="text-black">
                                    Appointement</a></h5>
            ...
            <div class="row">
                ...
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper align-left card1 ">
                        ...
                        <div class="card-img">
                        <img src="doctor/haematology.svg" alt=""  width="48px" height="48px">
                        </div>
                        <div class="card-box">
                            <h4 class="card-title pb-2 mbr-bold mbr-fonts-style display-5">Haematology Department</h4>
                            <p class="mbr-text pb-4 mbr-fonts-style display-4">The haematology department deals with investigation, treatment and prevention of blood diseases.</p>
                            <br>
                            <h5 class="link mbr-semibold mbr-fonts-style display-4"><a href="appointment.php" class="text-black">
                                    Appointement</a></h5>
                        </div>
                ...
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper  align-left card2 ">
                        ...
                        <div class="card-img">
                        <img src="doctor/paediatric.svg" alt=""  width="48px" height="48px">
                        </div>
                        <div class="card-box">
                            <h4 class="card-title pb-2 mbr-bold mbr-fonts-style display-5">
                                Paediatrics Department</h4>
                            <p class="mbr-text pb-4 mbr-fonts-style display-4">
                                The paediatrics department deals with infants, children and adolescents. </p>
                                <br>
                                <br>
                            <h5 class="link mbr-semibold mbr-fonts-style display-4"><a href="appointment.php" class="text-black">
                                    Appointement</a></h5>
                ...
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper  align-left card3 ">
                        ...
                        <div class="card-box">
                            <h4 class="card-title pb-2 mbr-bold mbr-fonts-style display-5">
                                Gynaecology and Obstetrics Department</h4>
                            <p class="mbr-text pb-4 mbr-fonts-style display-4">
                                The gynaecology department deals with investigation, treatment and prevention of female reproductive system and urinary tract problems.</p>
                            <h5 class="link mbr-semibold mbr-fonts-style display-4"><a href="appointment.php" class="text-black">
                                    Appointement</a></h5>
                        </div>
                    </div>
                ...
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper  align-left card4 ">
                        ...
                        <div class="card-img">
                        <img src="doctor/oncology.svg" alt=""  width="48px" height="48px">
                        </div>
                        <div class="card-box">
                            <h4 class="card-title pb-2 mbr-bold mbr-fonts-style display-5">Oncology Department</h4>
                            <p class="mbr-text pb-4 mbr-fonts-style display-4">
                                Oncology department deals with the investigation and treatment of cancers.</p>
                                <br>
                                <br>
                            <h5 class="link mbr-semibold mbr-fonts-style display-4"><a href="appointment.php" class="text-black">
                                    Appointement</a></h5>
                ...
                while ($row=mysqli_fetch_array($query)) { ?>
                    ...
                    <div class="card col-12 col-md-6 col-lg-3" style="margin-top:15px;">
                        <div class="card-wrapper align-left card1 ">
                            ...
                            <div class="card-img">
                                <img src="admin/<?php echo $row['image'];?>" alt="" width="48px" height="48px">
                            </div>
                            <div class="card-box">
                                <h4 class="card-title pb-2 mbr-bold mbr-fonts-style display-5"><?php  echo $row['department_name'];?></h4>
                                <p class="mbr-text pb-4 mbr-fonts-style display-4"><?php  echo $row['description'];?></p>
                                <h5 class="link mbr-semibold mbr-fonts-style display-4"><a href="appointment.php" class="text-black">
                                        Appointement</a></h5>
                            </div>
                        </div>
