...
<head>
    ...
    <title>Appointment| Samved Hospital</title>
</head>
...
<div class="hero-section">
  <br><br><br><br> <br> <img src="doctor/cont1.jpg" alt="not found">
    <div class="hero-content">
        <h1 class="mbr-section-title mbr-bold display-2">We take Care of Your Healthy Life</h1>
        <p class="mbr-text display-7">A Person who has good physical health is likely to have bodily functions and processes working at their peak.</p>
        <a class="btn btn-primary" href="contact.php">Enquire now</a>
    </div>
</div>
>
            </div>
