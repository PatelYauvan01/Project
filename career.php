...
<head>
    ...
    <title> CAREER | Samved Hospital </title>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-7 img-col">
                    <div class="mbr-figure">
                       <br><br><br><br> <img src="doctor/n4.webp" alt="not found">
                    </div>
                ...
                <div class="col-md-12 content align-left py-4 col-lg-5">
                  ...
                  <br><br><br><br>  <h1 class="mbr-section-title align-left mbr-bold pb-3 mbr-fonts-style display-2"> "Empowering
                        ...
                        <div class="dragArea form-row">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 form-group" data-for="nameFirst">
                                ...
                                <input type="text" name="nameFirst" placeholder="First Name" data-form-field="nameFirst"
                                    class="form-control display-7" value="" id="nameFirst-form1-3l">
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12 form-group" data-for="nameLast">
                                ...
                                <input type="text" name="nameLast" placeholder="Last Name" data-form-field="nameLast"
                                    class="form-control display-7" value="" id="nameLast-form1-3l">
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="text2">
                                ...
                                <input type="text" name="text2" placeholder="Address" data-form-field="text"
                                    class="form-control display-7" value="" id="text2-form1-3l">
                            </div>
                            <div data-for="date" class="col-lg-6 col-md-6 col-sm-6 form-group">
                                <h4>Date Of Birth</h4>
                                <input type="date" name="dob" placeholder="DOB" data-form-field="dob"
                                    class="form-control display-7"  id="dob">
                            </div>
                            <div data-for="select" class="col-lg-6 col-md-6 col-sm-6 select form-group">
                                <h4>Qualification</h4>
                            ...
                            <div data-for="email" class="col-lg-6 col-md-6 col-sm-6 form-group">
                                ...
                                <input type="email" name="email" placeholder="E-mail" data-form-field="email"
                                    class="form-control display-7" value="" id="email-form1-3l">
                            </div>
                            <div data-for="phone" class="col-lg-6 col-md-6 col-sm-6 form-group">
                                <h4>Phone Number</h4>
                            ...
                            <div data-for="select" class="col-lg-12 col-md-12 col-sm-12 select form-group">
                                ...
                                <input type="text" name="work" placeholder="Work Experince" data-form-field="work"
                                    class="form-control display-7" value="" id="work">
                            </div>
                            <div data-for="select" class="col-lg-12 col-md-12 col-sm-12 select form-group">
                                <h4>Skill</h4>
                                <input type="text" name="skill" placeholder="Skill" data-form-field="skill"
                                    class="form-control display-7" value="" id="skill">
                            </div>
                            <div data-for="select" class="col-lg-6 col-md-6 col-sm-6 select form-group">
                                <h4>Apply For</h4>
